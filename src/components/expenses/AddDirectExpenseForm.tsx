...
import ExpenseTabsForm, { ExpensePayload, Participant } from "@/components/expenses/ExpenseTabsForm";
...
// ref: "me" or "person:<index>", matching /api/expenses.
export default function AddDirectExpenseForm({
  ...
  userName: string;
  initialPeople?: PersonValue[];
  onSuccess?: () => void;
}) {
  const router = useRouter();
  const [people, setPeople] = useState<PersonValue[]>(initialPeople ?? [{ name: "", baseCurrency: "USD" }]);
