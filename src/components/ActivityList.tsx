...
export default function ActivityList() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("nakama:settlement-changed", onChanged);
    return () => {
      window.removeEventListener("nakama:expenses-changed", onChanged);
      window.removeEventListener("nakama:settlement-changed", onChanged);
    };
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
