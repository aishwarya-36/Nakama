...
// Custom dropdown: native <select> can't show a different closed-state label.
  ...
  return (
    <div ref={boxRef} className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex h-12 w-24 items-center justify-between rounded-md border border-border bg-surface px-3 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary/40"
      >
        {value}
