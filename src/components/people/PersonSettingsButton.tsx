...
import PersonForm, { EditablePerson } from "@/components/people/PersonForm";

export default function PersonSettingsButton({ person }: { person: EditablePerson }) {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Person settings">
        <PersonForm
          person={person}
          onSaved={() => {
            setOpen(false);
